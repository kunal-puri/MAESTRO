...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine bc_tower_level_build(bct,n,la)
    ...
    use variables, only : nscal,n_comp
  ...
  subroutine adv_bc_level_build(adv_bc_level,phys_bc_level,default_value)
    ...
    use variables, only: rho_comp, rhoh_comp, press_comp, &
         foextrap_comp, hoextrap_comp
...
!   COMP = 4...  : density, (rho h), (rho X)_i, temp, pi, tracers, pressure
    ...
    do i  = 1,2
       if (phys_bc_level(n,d,i) == SLIP_WALL) then
          ...
          adv_bc_level(n,d,i,   rho_comp)        = HOEXTRAP
          adv_bc_level(n,d,i,       1:dm)        = HOEXTRAP
          adv_bc_level(n,d,i, press_comp)        = FOEXTRAP
          ...
          adv_bc_level(n,d,i,   rho_comp)        = HOEXTRAP
          adv_bc_level(n,d,i,       1:dm)        = EXT_DIR
          adv_bc_level(n,d,i, press_comp)        = FOEXTRAP
  ...
  subroutine ell_bc_level_build(ell_bc_level,phys_bc_level,default_value)
    ...
    use variables, only: rho_comp, rhoh_comp, press_comp, foextrap_comp, hoextrap_comp
...
!   COMP = 4...  : density, (rho h), (rho X)_i, temp, pi, tracers, pressure
    ...
    do i = 1,2
       if (phys_bc_level(n,d,i) == SLIP_WALL) then
          ...
          ell_bc_level(n,d,i,   rho_comp)        = BC_DIR
          ell_bc_level(n,d,i,       1:dm)        = BC_NEU
          ell_bc_level(n,d,i, press_comp)        = BC_NEU
       ...
       !    ell_bc_level(n,d,i,hoextrap_comp)                    = BC_NEU   ! higher order extrap
          ...
          ell_bc_level(n,d,i,   rho_comp)        = BC_PER
          ell_bc_level(n,d,i,       1:dm)        = BC_PER
          ell_bc_level(n,d,i, press_comp)        = BC_PER
