  ...
  subroutine macproject(mla,ustar,phi,rho,dx,dt,the_bc_tower)
    ...
    do n = 1, nlevs
       ...
       do i = 1,dm
          ...
          call setval(beta(n,i),ONE,all=.true.)
       end do
    ...
    ! Solve the PPE
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    write(*,*) 'Solver tolerances', rel_solver_eps, abs_solver_eps
    if (use_hypre) then
...
1001 format('... level / max : EDGE vels   ',i2,2x,e17.10)
1101 format('... level / min : EDGE vels   ',i2,2x,e17.10)
1002 format('... level / max : EDGE vels   ',i2,2x,e17.10,2x,e17.10)
1102 format('... level / min : EDGE vels   ',i2,2x,e17.10,2x,e17.10)
1003 format('... level / max : EDGE vels   ',i2,2x,e17.10,2x,e17.10,2x,e17.10)
1103 format('... level / min : EDGE vels   ',i2,2x,e17.10,2x,e17.10,2x,e17.10)
